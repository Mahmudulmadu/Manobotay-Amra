...
include"header.php";
 ...
 <h1 class="h3 mb-2 text-gray-800">Funding Aids Program (LAP)</h1>
 <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">TORs (Terms of Reference) of FAP</h6>
                        </div>
                        <div class="card-body">
...
<h6 class="m-0 font-weight-bold text-primary">Needs Assessment:</h6>
 Must undergo a needs assessment to determine the Funding Aids Program required.
...
We may conduct evaluation visits to ensure that the Learning Aids are progressing as planned
