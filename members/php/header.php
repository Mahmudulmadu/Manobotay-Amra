<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Alif School System</a>
            </div>
 ...
 <li>
                        <a class="<?php if($page=='update-pic'){ echo 'active-menu';}?>" href="update-pic.php"><i class="fa fa-image "></i>Add Pictures</a>
                    </li>
                     <li>
                        <a class="<?php if($page=='notice'){ echo 'active-menu';}?>" href="notice.php"><i class="fa fa-bell "></i>Add Notice</a>
                    </li>
                    <li>
                        <a class="<?php if($page=='inact'){ echo 'active-menu';}?>" href="inactivestd.php"><i class="fa fa-toggle-off "></i>In-Active Students</a>
                    </li>
                    <li>
                        <a class="<?php if($page=='teachers'){ echo 'active-menu';}?>" href="teachers.php"><i class="fa fa-graduation-cap "></i>Manage Teachers</a>
                    </li>

                    <li>
                        <a class="<?php if($page=='grade'){ echo 'active-menu';}?>" href="grade.php"><i class="fa fa-th-large"></i>Grade Levels</a>
                    </li>
